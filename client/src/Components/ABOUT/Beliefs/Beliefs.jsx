...
export const Beliefs = () => {
  ...
  return (
    <section className="section ">
        <h3 className="title primary left">UPHOLDING THE PROTESTANT CONVICTION OF SOLA SCRIPTURA (“BIBLE ONLY”), THESE 28 FUNDAMENTAL BELIEFS DESCRIBE HOW SEVENTH-DAY ADVENTISTS INTERPRET SCRIPTURE FOR DAILY APPLICATION.</h3>
        ...
        <h5 className="left primary">The 28 Fundamental Beliefs can be organized into six categories of doctrine: God, man, salvation, the church, daily Christian life, and last-day events (restoration).</h5>
        <NormalFlex 
        ...
        <LearnMore header="Interested in learning more about the Bible and the beliefs of Adventist" link="https://www.adventist.org/study-the-bible/" path="Learn More" />
    </section>
  )
}
